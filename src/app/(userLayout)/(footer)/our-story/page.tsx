...
const OurStory = () => {
  return (
    <footer className="pt-10 xl:pt-20">
      <section className="flex flex-col md:flex-row gap-12 items-center justify-between border">
        ...
        <div className="w-full lg:w-7/12 p-6">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            ...
            nature meets nurture. Whether you are a seasoned plant parent or
            just starting out, we’re here to help your space thrive with fresh,
            healthy plants and expert tips along the way.
          </p>
        </div>
      </section>
    </footer>
